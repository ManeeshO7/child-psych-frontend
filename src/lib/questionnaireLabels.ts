...
export const QUESTIONNAIRE_LABELS: Record<string, string> = {
  ...
  internalizing_1: "Feels sad or unhappy",
  internalizing_2: "Feels hopeless",
  internalizing_3: "Is down on himself or herself",
  internalizing_4: "Worries a lot",
  internalizing_5: "Seems to be having less fun",
  attention_1: "Has trouble concentrating",
  attention_2: "Is easily distracted",
  attention_3: "Daydreams too much",
  attention_4: "Acts as if driven by a motor",
  attention_5: "Has trouble staying organized",
  externalizing_1: "Fights with others",
  externalizing_2: "Does not listen to rules",
  externalizing_3: "Does not understand other people's feelings",
  externalizing_4: "Teases others",
  externalizing_5: "Blames others for his or her troubles",
  externalizing_6: "Takes things that do not belong to him or her",
  externalizing_7: "Refuses to share",
